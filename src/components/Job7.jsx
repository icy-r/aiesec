      ...
      return (
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <ul className="text-white space-y-4">
            ...
            <li>
              Understanding and addressing synergy points with other positions
              as required
            </li>
            <li>Develop and design any required surveys</li>
            <li>
              Session streamlining and event flow management collaborating with
              Delegates VP’s
            </li>
          </ul>
        </div>
    ...
    <div className="flex flex-col md:min-w-full items-center py-8 px-4 md:px-8">
      ...
      <div className="w-full max-w-4xl bg-gray-800 rounded-lg shadow-lg overflow-auto">
        <div className="flex border-b border-gray-700">
          ...
          <button
            className={`w-1/3 py-4 text-center text-white text-lg font-semibold ${
              activeTab === "skills" ? "bg-gray-700" : "bg-gray-800"
            }`}

      ...
      return (
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <ul className="text-white text-lg space-y-4">
            ...
            <li>Guide the OC to fulfill ER and logistics requirements of the event.</li>
            <li>Ensure on-time promotions and communication between delegates and OC.</li>
            <li>Guide OC to deliver a good service to facilitators and delegates.</li>
            ...
            <li>Ensure marketing materials are ready & the calendar is booked the day before posting.</li>
          </ul>
        </div>
      );
    case 'outcomes':

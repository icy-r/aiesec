...
function New1() {
  return (
    <div className='min-h-screen text-white flex flex-col justify-center items-center p-4 md:p-8 lg:p-16' 
        >
      <div className='max-w-4xl mx-auto text-center'>
        <h2 className='text-4xl md:text-5xl lg:text-6xl font-bold mb-8 tracking-tight text-purple-950'>Benchmark <span className='text-white'>3.0</span></h2>
        <div className='text-lg md:text-xl lg:text-2xl mt-5 space-y-4'>
          <p className='leading-relaxed p-5 bg-slate-950 rounded-lg bg-opacity-20 shadow-md'>
